...
def tokenize(text: str) -> List[str]:
    """Lowercase alphanumeric tokens for the BM25 lexical signal. Commas are stripped first
    so multi-grouped numbers like '1,456,779' stay one token and match the corpus exactly."""
